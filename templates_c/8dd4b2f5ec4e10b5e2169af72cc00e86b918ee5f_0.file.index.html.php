<?php
/* Smarty version 3.1.34-dev-7, created on 2019-09-17 09:38:56
  from 'C:\xampp\htdocs\bookLunch\templates\index.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5d808d902ddd76_69472030',
...
function content_5d808d902ddd76_69472030 (Smarty_Internal_Template $_smarty_tpl) {
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input id="passwordMemberManagement" name="passwordMemberManagement" type="password" placeholder="請輸入密碼"
                                        class="form-control input-md" size="20" maxlength="20">
                                </div>
                                <div class="form-group">
                                    <label class="control-label" for="newPasswordMemberManagement">請輸入新密碼</label>
                                    <input id="newPasswordMemberManagement" name="newPasswordMemberManagement" type="password" placeholder="請輸入密碼"
                                        class="form-control input-md" size="20" maxlength="20">
                                </div>
                                <div class="form-group">
                                    <label class="control-label" for="newCheckPasswordMemberManagement">請再次確認新密碼</label>
                                    <input id="newCheckPasswordMemberManagement" name="newCheckPasswordMemberManagement" type="password" placeholder="請輸入密碼"
                                        class="form-control input-md" size="20" maxlength="20">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button id="updatePasswordMemberManagement" name="updatePasswordMemberManagement" type="button" class="btn btn-danger"
                                    data-dismiss="">變更密碼</button>
                                <button type="button" class="btn btn-default" data-dismiss="modal">返回</button>
                            </div>
                        </div>
...
元</h4>
                ...
                <div class="form-inline">
                    ...
                    <div class="form-group col-md-7">
                        備註：
                        <input maxlength="20" size="20" class="form-control" id="transactionRemarks<?php echo $_smarty_tpl->tpl_vars['data']->value['CommodityID'];?>
">
                    </div>
...
" class="btn btn-xs btn-info pull-right editButton">
                ...
                <input type="hidden" id="CommodityID" name="CommodityID" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['CommodityID'];?>
">
