<?php
/* Smarty version 3.1.34-dev-7, created on 2019-09-12 09:04:35
  from 'C:\xampp\htdocs\bookLunch\templates\create.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5d79ee031fdfb1_74692230',
...
function content_5d79ee031fdfb1_74692230 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <form method="post" action="" class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="commodityName">品名：</label>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-1">
                        <input type="number" class="form-control stockPriceInput" id="commodityStock" min="0" maxlength="5" value="0">
                    </div>
                    
                        <label class="control-label col-md-1" for="commodityPrice">價格：</label>
                    <div class="col-md-1">
                        <input type="number" class="form-control stockPriceInput" id="commodityPrice" min="0" maxlength="5" value="0">
                    </div>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="content">便當照片：</label>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <button type="submit" id="ok" name="ok" class="btn btn-success" value="OK">新增</button>
